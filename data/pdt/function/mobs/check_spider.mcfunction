...
execute if entity @p[distance=..64,scores={difficulty=5..}] run effect give @s speed infinite 1 false
execute if entity @p[distance=..64,scores={difficulty=5..}] run effect give @s strength infinite 3 false