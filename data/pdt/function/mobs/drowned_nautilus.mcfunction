...
execute as @e[tag=drowned_nautilus, sort=nearest, limit=1] at @s run summon minecraft:drowned ~ ~ ~ {Tags:["mini_drowned_nautilus", "checked_drowned"]}

execute as @e[tag=drowned_nautilus, sort=nearest, limit=1] at @s run summon minecraft:zombie_nautilus ~ ~ ~ {Tags:["mini_nautilus"]}
