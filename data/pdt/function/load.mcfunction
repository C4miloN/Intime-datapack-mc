...
scoreboard objectives add don_copper_block dummy
scoreboard objectives add don_gold_block dummy
scoreboard objectives add don_iron_block dummy
scoreboard objectives add don_diamond_block dummy
scoreboard objectives add don_netherite_scrap dummy
scoreboard objectives add don_netherite_block dummy
scoreboard objectives add don_batery dummy
scoreboard objectives add roulette_use dummy
scoreboard objectives add world_days dummy
...
execute as @a unless score @s death = @s death run function pdt:initialtime
...
execute as @a unless score @s don_copper_block = @s don_copper_block run scoreboard players set @s don_copper_block 0
execute as @a unless score @s don_gold_block = @s don_gold_block run scoreboard players set @s don_gold_block 0
execute as @a unless score @s don_iron_block = @s don_iron_block run scoreboard players set @s don_iron_block 0
execute as @a unless score @s don_diamond_block = @s don_diamond_block run scoreboard players set @s don_diamond_block 0
execute as @a unless score @s don_netherite_scrap = @s don_netherite_scrap run scoreboard players set @s don_netherite_scrap 0
execute as @a unless score @s don_netherite_block = @s don_netherite_block run scoreboard players set @s don_netherite_block 0
execute as @a unless score @s don_batery = @s don_batery run scoreboard players set @s don_batery 0
execute as @a unless score @s roulette_use = @s roulette_use run scoreboard players set @s roulette_use 0
execute as @a unless score @s world_days = @s world_days run scoreboard players set @s world_days 0
